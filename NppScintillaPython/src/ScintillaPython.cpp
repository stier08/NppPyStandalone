...
{
	OutputDebugString(L"[NppPyStandalonePlugin] [BEGIN] PpreinitScintillaModule");
	PN_INIT_PYTHON_MODULE(Npp);
	OutputDebugString(L"[NppPyStandalonePlugin] [END] preinitScintillaModule");
}
...
{
	OutputDebugString(L"[NppPyStandalonePlugin] [BEGIN] importScintilla");
	...
	OutputDebugString(L"[NppPyStandalonePlugin] [END] importScintilla");
